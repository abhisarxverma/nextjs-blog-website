...
export function Navbar() {
  ...
  return (
    <nav className="w-full py-5 px-4 flex items-center justify-between">
      <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8 justify-between w-full">
        <div className="flex items-center justify-between md:justify-start gap-6 md:gap-8">
          <Link href="/">
